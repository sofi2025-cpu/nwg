...
LATEST_VERSION=$(gh release list --repo nwg-piotr/nwg-shell-wallpapers --json name,tagName,isLatest --jq '.[] | select(.isLatest)|.tagName')
...
gh release download -R nwg-piotr/nwg-shell-wallpapers --archive=tar.gz --output "${VERSION}.tar.gz"
...
printf "nwg-shell-wallpapers updated\n"
