...
LATEST_VERSION=$(gh release list --repo nwg-piotr/nwg-readme-browser --json name,tagName,isLatest --jq '.[] | select(.isLatest)|.tagName')
...
gh release download -R nwg-piotr/nwg-readme-browser --archive=tar.gz --output "${VERSION}.tar.gz"
...
printf "nwg-readme-browser updated\n"
